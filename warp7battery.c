...
#define CHRG_GET_BC3770_CHARGE_EN       _IOW(CHRG_IOCTL_BASE, 15, unsigned char)
#define CHRG_SET_BC3770_CHARGE_EN       _IOW(CHRG_IOCTL_BASE, 16, unsigned char)
#define CHRG_GET_BC3770_SHDN            _IOW(CHRG_IOCTL_BASE, 17, unsigned char)
#define CHRG_SET_BC3770_SHDN            _IOW(CHRG_IOCTL_BASE, 18, unsigned char)
